...
fairseq-train $databin --lang-pairs eng_Latn-quy_Latn,eng_Latn-ayr_Latn,spa_Latn-quy_Latn,spa_Latn-ayr_Latn,spa_Latn-grn_Latn \
    --eval-lang-pairs spa_Latn-quy_Latn,spa_Latn-ayr_Latn,spa_Latn-grn_Latn \
    ...
    --lr 0.01 --lr-scheduler inverse_sqrt --warmup-updates 4000 \
    --max-update 200000 \
